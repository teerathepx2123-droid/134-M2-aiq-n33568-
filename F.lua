		...
		return function(Config)
			...
			TitleBar.Frame = New("Frame", {
				...
				New("Frame", {
					...
					-- Icon หน้า Title (แสดงเฉพาะเมื่อ Config.Icon ไม่ว่าง)
					New("ImageLabel", {
						Image = Config.Icon or "",
						Size = UDim2.fromOffset(16, 16),
						BackgroundTransparency = 1,
						Visible = (Config.Icon ~= nil and Config.Icon ~= ""),
						LayoutOrder = 0,
						ThemeTag = {
							ImageColor3 = "Text",
						},
	...
	[22] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(22)local TweenService = game:GetService("TweenService")
      ...
      function Element:New(Idx, Config)
      	...
      	local DropdownDisplay = New("TextLabel", {
      		...
      		TextSize = 13,
      		TextXAlignment = Enum.TextXAlignment.Left,
      		Size = UDim2.new(1, -28, 0, 14),  -- เว้นพื้นที่ icon ซ้าย
      		Position = UDim2.new(0, 26, 0.5, 0),  -- เริ่มหลัง icon
      		AnchorPoint = Vector2.new(0, 0.5),
      		BackgroundColor3 = Color3.fromRGB(255, 255, 255),
      		BackgroundTransparency = 1,
      	...
      	local DropdownIco = New("ImageLabel", {
      		...
      		Size = UDim2.fromOffset(14, 14),
      		AnchorPoint = Vector2.new(0, 0.5),
      		Position = UDim2.new(0, 7, 0.5, 0),  -- ชิดซ้าย
      		BackgroundTransparency = 1,
      		ThemeTag = {
      			ImageColor3 = "SubText",
      		},
        ...
        -- Layout:
        -- DropdownHolderFrame เป็น parent
        -- SearchBG: frame ครอบทั้ง search bar (มี rounded corner + bg)
        -- SearchIcon: x=8, center y=19, size=13x13
        -- SearchBox: เริ่มหลัง icon → x = 8+13+4 = 25, width = full - 25 - 8padding

        -- Frame ครอบ search bar ทั้งหมด (ทำ bg + corner ที่นี่แทน TextBox)
        ...
        -- icon อยู่ใน SearchBG: x=8, center y = 28/2=14, icon h=13 → y=14-6=7 (AnchorPoint center)
        ...
        -- TextBox เริ่มหลัง icon เลย: x = 8(margin)+13(icon)+4(gap) = 25
        -- width = SearchBG width - 25(left) - 8(right) = 1, -33
